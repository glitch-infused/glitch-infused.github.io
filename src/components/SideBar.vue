...
<template>
    <div class="bar">
        <div class="logo">
            <router-link to="/test" aria-label="return to the home page">
                <img src="../assets/icn.png" alt="icon">
            </router-link>
        </div>
        <div class="navigation">
            <div class="home">
                <router-link to="/" aria-label="return to the home page">
            ...
            <div class="search">
                <router-link to="/search" aria-label="search for something">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="statistics">
                <router-link to="/stats" onclick="console.log('click')" aria-label="view the statistics">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="account">
            <div class="settings">
                <router-link to="/account" aria-label="change account settings">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="notifications">
                <router-link to="/notifications" aria-label="view notifications">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
